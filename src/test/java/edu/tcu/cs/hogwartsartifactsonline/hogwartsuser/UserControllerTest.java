...
class UserControllerTest {
    ...
    void testFindUserByIdNotFound() throws Exception {
        //given: arrange inputs and targets, define the behavior of Mock object userService
        given(this.userService.findById(5)).willThrow(new UserNotFoundException("" + 5));
    ...
    void testUpdateUserSuccess() throws Exception {
        ...
        updatedUser.setId(3);
        updatedUser.setUsername("tom123"); //username is changed, was tom
    ...
    void testUpdateUserErrorWithNonExistentId() throws Exception {
        //given: arrange inputs and targets, define the behavior of Mock object userService
        given(this.userService.update(eq(5), Mockito.any(HogwartsUser.class))).willThrow(new UserNotFoundException("" + 5));
    ...
    void testDeleteUserErrorWithNonExistentId() throws Exception {
        //given: arrange inputs and targets, define the behavior of Mock object userService
        doThrow(new UserNotFoundException("" + 5)).when(this.userService).delete(5);
