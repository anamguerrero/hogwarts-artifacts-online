...
public class ExceptionHandlerAdvice {
    ...
    /*
     * Param1: user does not exist
     * Param2: username is correct, but password is wrong
     */
    ...
    /**
     * fallback handles any unhandled exceptions (only called with any other handler doesn't work)
     *
     * @param ex
     * @return
     */
